...
function init(){
    ...
    renderer.setClearColor(0xeff6ff);
    ...
    var material = new THREE.PointsMaterial({color: 0xffffff, size:2, transparent:true, opacity:0.75});
    star = new THREE.Points(geometry, material);
    scene.add(star);

    var geometry = new THREE.SphereGeometry( 200, 20, 20 );
    var material = new THREE.MeshBasicMaterial( {color: 0x1890c9, transparent:true, opacity:0.05, wireframe:true} );
